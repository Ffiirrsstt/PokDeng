...
namespace project
{
    internal class Picture_move
    {
        ...
        public void Deconstruct(out PictureBox pic, out Point loc, out Point loc_target, out bool display, out bool start_move)
        {
            pic = this.pic;
            loc = this.loc;
        ...
        public Picture_move tuple_dic_deck(PictureBox pic,PictureBox deck, int x_target, int y_target, bool dis = true, bool move = false)
        {
