...
namespace project
{
    internal class Player
    {
        ...
        //กี่เท่า, เดิมพัน
        public void money_in(int times, int bet) => money = (times* bet)+ money;
        public void money_out(int times, int bet) => money = money - ((times-1) * bet); //(times-1) เพราะตอนเริ่มเดิมพันหักส่วนเดิมพันไปแล้ว
